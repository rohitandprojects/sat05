  ...
  return (
    ...
    <section className="section banner-main export-banner" ref={cargoRef}>
		<div className="cardgo-main">
			...
			<h1 ref={cargoTitleRef}>Export in 10+ Countries</h1>
		</div>
	</section>
	<section className="section world-map" ref={worldMapRef}>
		<div className="world-map-div position-relative">
			...
			<div className="world-map-sub position-relative">
				...
				<Link href={'#'} className="position-absolute toolteep canada"><div className="position-absolute"><span>CANADA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep usa"><div className="position-absolute"><span>USA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep africa"><div className="position-absolute"><span>AFRICA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep uganda"><div className="position-absolute"><span>UGANDA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep saudi"><div className="position-absolute"><span>SAUDI ARABIA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep uae"><div className="position-absolute"><span>UAE</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep india"><div className="position-absolute"><span>INDIA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep thailand"><div className="position-absolute"><span>THAILAND</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep malaysia"><div className="position-absolute"><span>MALAYSIA</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep singapore"><div className="position-absolute"><span>SINGAPORE</span></div></Link>
				<Link href={'#'} className="position-absolute toolteep australia"><div className="position-absolute"><span>AUSTRALIA</span></div></Link>
				</div>
			</div>
		...
		<div className="w-100 text-center">	
			<div className="weserve-certification">
				...
				<ul className="w-100 d-flex justify-content-between align-items-center btmToTp">
					<li><ExportedImage src="/images/fssai.webp" width={187} height={107} alt="fssai" /></li>
					<li><ExportedImage src="/images/ISO.webp" width={103} height={106} alt="ISO" /></li>
					<li><ExportedImage src="/images/export-quality-product.webp" width={148} height={95} alt="export quality product" /></li>
					<li><ExportedImage src="/images/BRC-Food.webp" width={92} height={149} alt="BRC-Food" /></li>
					<li><ExportedImage src="/images/FDA.webp" width={181} height={79} alt="FDA" /></li>
					<li><ExportedImage src="/images/HALAL.webp" width={97} height={149} alt="HALAL" /></li>
				</ul>
			</div>
		</div>
	</section>
