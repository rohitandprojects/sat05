...
export default function Home() {	 
	useEffect(()=>{
		...
		if(ww > 767){
			sceneOne.to('.scene1-house', { duration:10,ease: "power1.inOut",scale:3,delay:-5.5});
			console.log('> 768');
		}
		else{
			sceneOne.to('.scene1-house', { duration:10,ease: "power1.inOut",scale:1.75,delay:-5.5});
			console.log('< 768');
		}
		...
		if(ww > 767){
			sceneOne.to('.chilli-powder', { duration:10,ease: "power1.inOut",top:0,delay:-1});
			console.log('> 768');
		}
		else{
			sceneOne.to('.chilli-powder', { duration:10,ease: "power1.inOut",top:0,delay:-1});
		...
		sceneOne.to('.title-two', { duration:8,ease: "power1.inOut",top:0,delay:-6.5});
		sceneOne.to('.title-two .pipe', { duration:8,ease: "power1.inOut",top:'calc(100% + 50px)',delay:-5});
		
		sceneOne.to('.chilli-powder', { duration:8,ease: "power1.inOut",top:'calc(100% + 200px)',delay:0},'chilliMill').call(playGrandma, ['rohit', 'dubariya'], "<-8");
		sceneOne.to('.traditional-mill', { duration:0,ease: "power1.inOut",left:'0%',delay:0},'chilliMill').call(playPauseMill, ['rohit', 'dubariya'], "<");
		sceneOne.to('.title-two', { duration:8,ease: "power1.inOut",top:'100%',delay:-7.25});
		sceneOne.to('.title-two .pipe', { duration:8,ease: "power1.inOut",top:'150%',delay:-7.25});
		/*sceneOne.to('.dhanajiru-powder', { duration:8,ease: "power1.inOut",left:'0%',delay:0},'dhanajiru_vid').call(playPauseMill, ['rohit', 'dubariya'], ">");*/
		if(ww > 767){
			sceneOne.to('.dhanajiru-powder', { duration:8,ease: "power1.inOut",left:'calc(0% - 200px)',delay:-1.5});
			console.log('> 768');
		}
		else{
			sceneOne.to('.dhanajiru-powder', { duration:8,ease: "power1.inOut",left:'calc(0% - 100px)',delay:-3.25});
			console.log('< 768');
		}
		...
		sceneOne.to('.title-three-one', { duration:8,ease: "power1.inOut",left:'0%',delay:-6.5});
		sceneOne.to('.title-three-two', { duration:8,ease: "power1.inOut",bottom:'0%',delay:0});
		sceneOne.to('.title-three-two .pipe', { duration:8,ease: "power1.inOut",bottom:'calc(100% + 20px)',delay:-5});
		sceneOne.to('.title-three-one', { duration:8,ease: "power1.inOut",top:'100%',delay:-8.5});
		sceneOne.to('.title-three-two', { duration:8,ease: "power1.inOut",bottom:'100%',delay:0});
		sceneOne.to('.dhanajiru-powder', { duration:8,ease: "power1.inOut",left:'100%',delay:-5},'cryogenicMill');
		...
		sceneOne.to('.crayogenic-graiding', { duration:8,ease: "power1.inOut",top:'-100%',delay:1},'graiding').call(playPauseCryogenic, ['om', 'naam'], ">-2");
		sceneOne.to('.crayogenic-graiding_stand', { duration:8,ease: "power1.inOut",top:'100%',delay:1},'graiding');
	
		sceneOne.to('.nozel', { duration:8,ease: "power1.inOut",top:'0%',delay:-9},'nozel');
		sceneOne.to('.box-masala', { duration:8,ease: "power1.inOut",top:'0%',delay:-7.5},'nozel');
		sceneOne.to('.belt-strip', { duration:8,ease: "power1.inOut",top:'0%',delay:-7.5},'nozel');
      ...
      <section className="section wh-100 trigger scene-one">
		...
		<div className="cryogenic-mill w-100 position-absolute">
			...
			<div className="crayogenic-graiding position-absolute">
				...
				<picture>
					<source media={`(max-width: 575px)`} srcSet="/slides/crayogenic-grainder.webp" />
					<source media={`(min-width: 576px)`} srcSet="/slides/crayogenic-grainder.webp"/>
			...
			<div className="crayogenic-graiding_stand position-absolute">
				...
				<picture>
					<source media={`(max-width: 575px)`} srcSet="/slides/crayogenic-graiding_stand.webp" />
					<source media={`(min-width: 576px)`} srcSet="/slides/crayogenic-graiding_stand.webp"/>
			...
			<div className="nozel position-absolute">
				<div className="nozel-canvas-wrapper position-absolute">
					...
					<ExportedImage src="/slides/nozel-img.webp" className="position-absolute" width={252} height={152} alt="nozel" />
					...
					<div className="box-masala-subsub position-absolute">
						<div className="box-1 position-absolute">
							...
							<picture>
								...
								<source media={`(min-width: 576px)`} srcSet="/slides/box1.webp"/>
								<ExportedImage src="/slides/box1.webp" width={1920} height={1080} alt="masala box" />
							</picture>
							</div>
						</div>
